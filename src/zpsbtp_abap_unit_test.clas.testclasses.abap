...
CLASS zpsbtp_abap_unit_test DEFINITION LOCAL FRIENDS ltc_test_simple_1
                                                      ltc_test_simple_2
                                                      ltc_test_doc_seam
                                                      ltc_test_doc_global_itf
...
METHOD test_get_digit_sum.
  ...
  DATA(ref_cut) = NEW zpsbtp_abap_unit_test( ).
  ...
  DATA(tab_digit_sum) = VALUE zpsbtp_abap_unit_test=>nums_tab( ( num1 = 124 num2 = 7 )
                                                                  ( num1 = 57 num2 = 12 )
                                                                  ( num1 = 11111 num2 = 5 )
                                                                  ( num1 = 1000 num2 = 1 )
                                                                  ( num1 = 0 num2 = 0 )
...
PRIVATE SECTION.
  ...
  TYPES: BEGIN OF nums,
            num1       TYPE i,
            num2       TYPE i,
            common_div TYPE zpsbtp_abap_unit_test=>int_tab_so,
            gcd        TYPE i,
          END OF nums,
          tab_type TYPE TABLE OF nums WITH EMPTY KEY.

  DATA: ref_cut TYPE REF TO zpsbtp_abap_unit_test.
...
METHOD test_get_common_div_gcd_fail.
  ...
  DATA(num1) = 6.
  DATA(num2) = 3.
  DATA(c_div) = VALUE zpsbtp_abap_unit_test=>int_tab_st( ( 1 ) ( 2 ) ). "correct: 1, 3
...
METHOD test_multiple_asserts_ok.
  ...
  DATA(ref) = NEW zpsbtp_abap_unit_test( ).
...
METHOD test_multiple_asserts_fail.
  ...
  DATA ref TYPE REF TO zpsbtp_abap_unit_test.
...
INHERITING FROM zpsbtp_abap_unit_test.
