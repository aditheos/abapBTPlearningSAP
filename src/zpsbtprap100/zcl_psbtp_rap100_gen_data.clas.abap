CLASS zcl_psbtp_rap100_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_psbtp_rap100_gen_data IMPLEMENTATION.
...
*   clear data
    DELETE FROM zpsbtp_atrav.

    "insert travel demo data
    INSERT zpsbtp_atrav  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZPSBTP_ATRAV. | ).
  ENDMETHOD.
ENDCLASS.
