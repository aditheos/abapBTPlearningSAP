CLASS lhc_zr_psbtp_atrav DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    CONSTANTS:
    ...
    METHODS:
      ...
      setOpenStatus FOR DETERMINE ON MODIFY
        IMPORTING keys FOR Travel~setOpenStatus,
...
CLASS lhc_zr_psbtp_atrav IMPLEMENTATION.
  METHOD get_global_authorizations.
  ENDMETHOD.
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_psbtp_atrav,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zpsbtp_atrav FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zpsbtp_atrav_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setOpenStatus.
    ...
    READ ENTITIES OF zr_psbtp_atrav IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zr_psbtp_atrav IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_psbtp_atrav.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
       travels       TYPE TABLE FOR CREATE zr_psbtp_atrav\\travel.
